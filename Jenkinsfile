  ...
  stages {
    ...
    stage('Hockey deployment') {
      ...
      steps {
        ...
        sh 'xcodebuild -workspace GiniSwitchSDK/Example/GiniSwitchSDK.xcworkspace -scheme GiniSwitchSDK-Example -configuration Release archive -archivePath build/GiniSwitchSDKExample.xcarchive'
