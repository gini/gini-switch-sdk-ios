...
class PreviewViewController: UIViewController {
    ...
    private func populate(with page:ScanPage?) {
        ...
        case .analysed:
            ...
            statusView.image = UIImage(named: "pageUploadSuccessCheckmarkCircle", in: Bundle(identifier: "org.cocoapods.GiniSwitchSDK"), compatibleWith: nil)
            titleView.text = analysedPageTitle
            break
        case .failed:
            // add the "X" marker in the middle of the preview
            // change the title text accordingly
            statusView.image = UIImage(named: "pageUploadFailedCrossCircle", in: Bundle(identifier: "org.cocoapods.GiniSwitchSDK"), compatibleWith: nil)
