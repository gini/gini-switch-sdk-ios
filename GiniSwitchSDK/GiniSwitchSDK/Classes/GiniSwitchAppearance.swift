...
public class GiniSwitchAppearance {
     ...
     */
    static public var primaryColor:UIColor? = UIColor(red: 22.0 / 255.0,
                                                      green: 157.0 / 255.0,
                                                      blue: 217.0 / 255.0,
                                                      alpha: 1.0)
     ...
     */
    static public var positiveColor:UIColor? = UIColor(red: 32.0 / 255.0,
                                                       green: 186.0 / 255.0,
                                                       blue: 167.0 / 255.0,
                                                       alpha: 1.0)
     ...
     */
    static public var negativeColor:UIColor? = UIColor(red: 204.0 / 255.0,
                                                       green: 33.0 / 255.0,
                                                       blue: 102.0 / 255.0,
                                                       alpha: 1.0)
     ...
     */
    static public var doneButtonTextColor:UIColor? = UIColor(red: 22.0 / 255.0,
                                                             green: 157.0 / 255.0,
                                                             blue: 217.0 / 255.0,
                                                             alpha: 1.0)
     ...
     */
    static public var imageProcessedText:String? = NSLocalizedString(
        "Sehr gut, wir könnten alle Daten aus diesem Foto erfolgreich analysieren.",
        comment: "Preview screen title - analyzed document")
    
    /**
     * Text for the Preview screen - a failed processing of the image.
     */
    static public var imageProcessFailedText:String? = NSLocalizedString(
        "Leider ist die Qualität dieser Seite nicht ausreichend. Bitte fotografiere diese Seite nochmal neu.",
        comment: "Preview screen title - failed document")
    
    /**
     * Image for the Analysing Completed Screen.
     */
    static public var analyzedImage:UIImage?
    
    /**
     * Text for the Analysing Completed Screen.
     */
    static public var analyzedText:String? = NSLocalizedString(
        "Wir haben alles, was für den Anbieterwechsel benötigt wird.",
        comment: "Text for the Analysing Completed Screen")
     ...
     */
    static public var exitActionSheetTitle: String? = NSLocalizedString("Foto-Modus verlassen?",
                                                                       comment: "Leave SDK actionsheet title")
